...
ActiveRecord::Schema[7.1].define(version: 2025_07_26_081906) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["checklist_item_id"], name: "index_likes_on_checklist_item_id"
    t.index ["user_id"], name: "index_likes_on_user_id"
  end

  create_table "reusable_items", force: :cascade do |t|
    t.string "name"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_reusable_items_on_user_id"
  end
  ...
  add_foreign_key "reusable_items", "users"
